...
- [main(default) 브랜치](https://lab.ssafy.com/s10-webmobile1-sub2/S10P12A105/-/tree/main?ref_type=heads): 프로젝트의 아키텍처 관련 자료와 기본적인 문서가 저장되어 있습니다. 이 브랜치는 프로젝트의 기본 구조를 정의하고, 전반적인 아키텍처 설계를 제공합니다.
